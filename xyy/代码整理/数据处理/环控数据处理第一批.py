...
all_HumTem_data=pd.read_csv('./data/data_cleaned/all_HumTem_data1.csv',encoding='gbk')
...
data['湿度外部平均']=data['湿度外部平均'].replace('---',None)
data['湿度内部平均']=data['湿度内部平均'].replace('---',None)
