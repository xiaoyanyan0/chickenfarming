...
#     variable_name='water_per_shift_diff_前2天', ##需更改的字段
#     Age_interval='16 - 18日龄',  ##对应的日龄
#     new_bins=[
#          '[-inf, -5.76)',
#     '[-5.76, 8.45)',
#     '[8.45, 14.47)',
#     '[14.47, inf)'
#     ],    ##更改后新的分箱
#     input_file=".\\xyy\\死淘分析\\output\\winter_饮水差值分箱_Optimized.csv",  ##原始分箱结果
#     output_file=".\\xyy\\死淘分析\\output\\winter_饮水差值分箱_Optimized1.csv",  ##新的分箱结果
#     target='MORTALITY_RATE'  ##限制目标是MORTALITY_RATE或EEF
# )
